...
from sgn.sources import SourceElement, SignalEOS
from sgn.sinks import NullSink
from sgnts.base import EventFrame, EventBuffer
...
nsubbank, ntemplate = strike_object.all_template_ids.shape
...
if True:
    with SnapShotControl() as control, SubProcess(pipeline) as subprocess:
        subprocess.run()
else:
